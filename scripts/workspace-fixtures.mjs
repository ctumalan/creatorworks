...
export function workspaceFixtures(){
 ...
 const db=mockDatabase(tables,{cw_project_unread:()=>projects.map(p=>({slug:p.slug,unread_count:2})),cw_workspace_inbox:()=>[{id,project_slug:'sample-0',title:'Grocery planner',counterpart:'Sample Reviewer',last_message:feedback.message,last_at:now,unread:true,total_count:1}]});
