...
export function authMessage(message: string, status = 503) {
  return new Response(`<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width"><title>CreatorWorks sign-in</title><link rel="stylesheet" href="/styles.css"><main class="account-hero"><p class="eyebrow">CreatorWorks</p><h1>Welcome.</h1><p>${message}</p><a class="primary-button" href="/">Browse the projects</a></main></html>`, { status, headers: { 'Content-Type': 'text/html; charset=utf-8', 'Cache-Control': 'no-store' } });
}
