...
export const GET:APIRoute=async context=>{
 try{
  ...
  const tables=[['profiles','user_id'],['projects','owner_user_id'],['saved_projects','user_id'],['creator_feedback','author_user_id'],['feedback_replies','author_user_id'],['project_experiences','author_user_id'],['daily_discussion_comments','user_id'],['feedback_qualifications','user_id'],['credit_ledger','user_id'],['feedback_requests','user_id'],['project_slot_grants','user_id'],['project_slot_assignments','user_id'],['account_preferences','user_id'],['notifications','user_id'],['support_cases','user_id'],['support_messages','author_id'],['account_deletion_requests','user_id']];
